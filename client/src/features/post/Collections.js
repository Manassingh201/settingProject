...
export default function UserForm() {
  ...
  const [Change,onChange]=useState('default');
  return (
    <div>
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li onClick={()=>{onChange('collect')}}>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">My Collection</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Genrate image</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div className="p-4 sm:ml-64">
    {(Change === "Dashboard") && <Allcollection></Allcollection>}
    {(Change === "collect") && <Card></Card>}
</div>
</div>
  )
}
